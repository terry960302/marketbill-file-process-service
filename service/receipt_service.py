...
class ReceiptService:
    ...
    def process_receipt_data_to_excel(self) -> (str, Workbook):
        """
        1. 양식 엑셀을 복사
        2. 복사한 엑셀에서 값을 넣는다
        3. 값을 넣은 후 저장한다.
        ...
        try:
            ...
            def update_rows(_sheet: Worksheet, row: int, _item: dto.OrderItem):
    ...
    """
    읽기 편한 openpyxl 코드입니다.(대신 효율성이 별로...물론 데이터가 많은 경우에 해당)
    """
...
if __name__ == "__main__":
    ...
    print("상품 개수 : ", len(json_input.orderItems))
